...
def passport_checker(passports):
    valid_documents = 0
    more_valid_documents = 0
    for passpost_details in passports:
        # print(passpost_details)
        ...
        for details in details_list:
          ...
          for i in subdetails:
            clear_details_list.append(i)

        #     Tym sposobem otrzymaliśmy w clean_details_list wyczyszzczone listy poszczególnych paszportów,
        ...
        if "byr" in existing_keys_list and \
            ...
            if passed_test == 7:
                more_valid_documents += 1
            valid_documents += 1

    print("Dokumenty zawierające wszystkie klucze: ", valid_documents)
    print("Dokumenty poprawne: ", more_valid_documents)
